...
export function Tooltip({ text, children }: TooltipProps) {
  ...
  return (
    ...
    >
      ...
      {show && (
        <span className="absolute bottom-full left-1/2 z-50 mb-2 -translate-x-1/2 whitespace-normal rounded-lg bg-gray-900 px-3 py-2 text-xs leading-relaxed text-white shadow-lg dark:bg-gray-700" style={{ minWidth: '200px', maxWidth: '280px' }}>
          {text}
