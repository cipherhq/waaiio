...
const STORAGE_KEY = 'waaiio_last_activity';
      ...
      <div className="mx-4 w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl dark:bg-gray-800">
        ...
        <div className="mt-6 flex gap-3">
          <button
            ...
            className="flex-1 rounded-lg bg-brand px-4 py-2.5 text-sm font-semibold text-white hover:bg-brand-600 transition-colors"
          >
            Stay Signed In
          </button>
          <button
