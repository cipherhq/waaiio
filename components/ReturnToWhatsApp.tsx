...
export function ReturnToWhatsApp({ phone }: { phone?: string }) {
  ...
  // Priority: business channel number → US shared number (primary platform) → NG → Gupshup
  ...
  return (
    <a
      href={waLink}
      className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#1ebe5d]"
    >
