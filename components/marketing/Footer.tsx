        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-gray-400">
              ...
              payments, orders, and sell tickets 24/7 on the app your
            ...
            <div className="mt-4 flex items-center gap-3 text-gray-500">
              {/* WhatsApp */}
              <a href="#" className="transition hover:text-whatsapp" aria-label="WhatsApp">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link href="/get-started" className="text-sm text-gray-400 hover:text-white transition">
                  Get Started
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <span className="text-sm text-gray-400">Ordering</span>
              </li>
              <li>
                <span className="text-sm text-gray-400">Ticketing</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link href="/acceptable-use" className="text-sm text-gray-400 hover:text-white transition">
                  Acceptable Use
                </Link>
              </li>
              <li>
                <Link href="/dpa" className="text-sm text-gray-400 hover:text-white transition">
                  Data Processing (DPA)
                </Link>
              </li>
              <li>
