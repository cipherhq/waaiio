        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-4 flex items-center gap-3 text-gray-500">
              <a href="#" className="transition hover:text-[#25D366]" aria-label="WhatsApp">
              ...
              <a href="#" className="transition hover:text-blue-400" aria-label="LinkedIn">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li><span className="text-sm text-gray-400">Scheduling</span></li>
              <li><span className="text-sm text-gray-400">Payments</span></li>
              <li><span className="text-sm text-gray-400">Ordering</span></li>
              <li><span className="text-sm text-gray-400">Ticketing</span></li>
              <li><span className="text-sm text-gray-400">Loyalty &amp; Referrals</span></li>
              <li><span className="text-sm text-gray-400">Broadcasts</span></li>
              <li><span className="text-sm text-gray-400">Queue Management</span></li>
            </ul>
          </div>
