        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-4 flex items-center gap-3 text-gray-500">
              <a href={getSupportWhatsAppLink() || '#'} target="_blank" rel="noopener noreferrer" className={`transition hover:text-whatsapp ${!getSupportWhatsAppLink() ? 'hidden' : ''}`} aria-label="WhatsApp">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li><Link href="/blog" className="text-sm text-gray-300 transition hover:text-white">Blog</Link></li>
              <li><Link href="/white-label" className="text-sm text-gray-300 transition hover:text-white">White Label</Link></li>
