...
export const router = createBrowserRouter([
  { path: '/login', Component: Login },
  {
    ...
    children: [
      ...
      { path: 'category-templates', element: <RoleGuard roles={['admin']}><CategoryTemplates /></RoleGuard> },
      ...
      { path: 'pending-transfers', element: <RoleGuard roles={['admin', 'finance']}><PendingTransfers /></RoleGuard> },
      ...
      // Content & System
      { path: 'content', element: <RoleGuard roles={['admin']}><ContentManagement /></RoleGuard> },
      ...
      { path: 'ai-setup-log', element: <RoleGuard roles={['admin']}><AISetupLog /></RoleGuard> },
      { path: 'ai-usage', element: <RoleGuard roles={['admin']}><AIUsage /></RoleGuard> },
      { path: 'conversation-usage', element: <RoleGuard roles={['admin']}><ConversationUsage /></RoleGuard> },
      ...
      { path: 'system-health', element: <RoleGuard roles={['admin']}><SystemHealth /></RoleGuard> },
