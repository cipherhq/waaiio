...
| 246 | `phone_otp_challenges` | Production verified (Batch 9, waiting for Batch 8 repair closeout) | #35 | Batch 9 production-verified 2026-07-30. 13 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-09-production-verification.json` (SHA `531f94b3`). |
| 245 | `fix_book_slot_atomic_overloads` | Production verified (Batch 9, waiting for Batch 8 repair closeout) | — | Batch 9 production-verified 2026-07-30. 4 objects: 3 exact match, 1 equivalent-stricter (`book_slot_atomic` execute grants — Migration 296 revokes EXECUTE from anon/authenticated with role-existence guards, stricter than original). Not yet remotely tracked. Verification evidence: `batch-09-production-verification.json` (SHA `531f94b3`). |
...
| 241 | `growth_engine` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 59 objects: 58 exact match, 1 superseded (`customer_consents.customer_consents_service_insert` policy — superseded by Migration 242). Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (SHA `bc5ac316`). |
| 240 | `ai_classification_log_owner_rls` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 1 object, exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (SHA `bc5ac316`). |
| 239 | `ai_conversation_config` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 13 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (SHA `bc5ac316`). |
| 238 | `remove_gupshup` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 2 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (SHA `bc5ac316`). |
| 237 | `opt_out_suppression` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 5 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (SHA `bc5ac316`). |
| 236 | `session_versioning` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 4 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (SHA `bc5ac316`). |
...
| 234 | `revoke_catalog_order_public` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 2 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (SHA `bc5ac316`). |
...
| 232 | `webhook_event_state_machine` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 3 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (SHA `bc5ac316`). |
...
| 228 | `add_pending_subscription_status` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 1 object, exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (SHA `bc5ac316`). |
| 227 | `customer_ltv_tier` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 2 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (SHA `bc5ac316`). |
...
- **19 verified and pending repair:** Batch 8 (15 versions, active for repair) + Batch 9 (4 versions, waiting for Batch 8 closeout)
