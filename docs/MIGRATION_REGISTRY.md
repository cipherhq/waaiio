...
| 246 | `phone_otp_challenges` | Batch 9 repaired (tracked) | #35 | Batch 9 production-verified 2026-07-30. 13 objects, all exact match. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 245 | `fix_book_slot_atomic_overloads` | Batch 9 repaired (tracked) | — | Batch 9 production-verified 2026-07-30. 4 objects: 3 exact match, 1 equivalent-stricter (`book_slot_atomic` execute grants — Migration 296 revokes EXECUTE from anon/authenticated with role-existence guards, stricter than original). Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 243 | `growth_credit_hardening` | Batch 9 repaired (tracked) | — | Batch 9 production-verified 2026-07-30. 17 objects, all exact match. Supersedes 7 objects from Migration 242 (reserve_credits_atomic, consume_credits_atomic, release_expired_credits function bodies and grants, uq_growth_campaign_dedup constraint). Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 242 | `growth_credit_atomic` | Batch 9 repaired (tracked) | — | Batch 9 production-verified 2026-07-30. 8 objects: 1 exact match, 7 superseded by Migration 243 (`243_growth_credit_hardening.sql`). Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 241 | `growth_engine` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 59 objects: 58 exact match, 1 superseded (`customer_consents.customer_consents_service_insert` policy — superseded by Migration 242). Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 240 | `ai_classification_log_owner_rls` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 1 object, exact match. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 239 | `ai_conversation_config` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 13 objects, all exact match. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 238 | `remove_gupshup` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 2 objects, all exact match. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 237 | `opt_out_suppression` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 5 objects, all exact match. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 236 | `session_versioning` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 4 objects, all exact match. One comment-only raw-definition difference (normalized executable SQL identical; no committed matching blob exists). Remote history repair completed 2026-07-31. No SQL executed. V3 evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 235 | `catalog_order_quantity_validation` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 1 object, exact match. Supersedes Migration 231 `create_catalog_order_atomic` function body. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 234 | `revoke_catalog_order_public` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 2 objects, all exact match. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 233 | `atomic_recurring_charge` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 3 objects: 1 exact match, 1 equivalent-stricter (`process_recurring_charge.revoke_public` — Migration 295 closes DEFAULT PRIVILEGES gap), 1 superseded (function body superseded by Migration 244 `payment_source_classification`). Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 232 | `webhook_event_state_machine` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 3 objects, all exact match. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 231 | `atomic_catalog_order` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 1 object, superseded (function body superseded by Migration 235 `catalog_order_quantity_validation`). Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 230 | `attendance_rls_hardening` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 7 objects, all exact match. Supersedes Migration 229 `attendance_log.service_insert` policy. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 229 | `attendance_log` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 7 objects: 6 exact match, 1 superseded (`attendance_log.service_insert` policy — superseded by Migration 230 `attendance_rls_hardening`). Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 228 | `add_pending_subscription_status` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 1 object, exact match. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 227 | `customer_ltv_tier` | Batch 8 repaired (tracked) | — | Batch 8 production-verified 2026-07-30. 2 objects, all exact match. Remote history repair completed 2026-07-31. No SQL executed. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
...
| 225 | `flow_dropoff_analytics` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 224 | `event_tickets_reminder_sent` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 223 | `security_fix_exposed_tables` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Policy `public_read_active_businesses` on businesses superseded by Migration 293 (`293_fix_production_table_exposure.sql`) — policy dropped and replaced with stricter role-based access. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 221 | `admin_permissions` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 220 | `profiles_admin_insert` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 219 | `admin_rls_missing_tables` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 218 | `resellers_admin_rls` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 215 | `annual_billing` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 214 | `security_rls_fix` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 213 | `pending_transfers_campaign_id` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 212 | `platform_fee_invoices` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 211 | `ocr_result_and_admin_rls` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 210 | `receipt_ocr` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 209 | `direct_bank_transfer` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 208 | `payment_channels` | Batch 7 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-07-production-verification.json` (SHA `ef3822de`). Repair evidence: `batch-07-repair.json` (SHA `d99a37ee`). |
| 207 | `reseller_full` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 206 | `demo_requests` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 205 | `resellers` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 204 | `party_enhancements` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 203 | `keyword_campaigns` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 202 | `balance_reminder_settings` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 201 | `session_security` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 198 | `party_custom_responses` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 197 | `event_refund_policy` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 196 | `waiver_capability_enum` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 195 | `pay_link_limits` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 194 | `blocked_phones_table` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 193 | `fix_search_path` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 192 | `secure_revenue_rpcs` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
| 191 | `scan_to_pay` | Batch 6 repaired (tracked) | — | Remote history repair completed 2026-07-30. No SQL executed. Verification evidence: `batch-06-production-verification.json` (SHA `0fc3ff1f`). Repair evidence: `batch-06-repair.json` (SHA `e38ca82b`). |
...
**Batch 6 repair summary:** 15 versions (191-207) now tracked in remote schema_migrations. Remote count 179 -> 194 (+15). 101-246 tracked count 83 -> 98 (+15). 90 total completed migration-history repairs. Verification evidence: `docs/migrations/evidence/batch-06-production-verification.json` (SHA: `0fc3ff1f5f56644c0570a6f6ff30f7961a873dae29aab02abe7fa83cd3c60cf6`). Repair evidence: `docs/migrations/evidence/batch-06-repair.json` (SHA: `e38ca82b69f8112c6b312ca5b966c3cecc2e5f28f7a621003ce378241de25d16`). No migration SQL executed. History-only operation.
**Batch 7 repair summary:** 15 versions (208-225) now tracked in remote schema_migrations. Remote count 194 -> 209 (+15). 101-246 tracked count 98 -> 113 (+15). 105 total completed migration-history repairs. Verification evidence: `docs/migrations/evidence/batch-07-production-verification.json` (SHA: `ef3822deec7191c1a6b5fee69afd8c0c97fb588b6458cdc7aa86feeda5b66c00`). Repair evidence: `docs/migrations/evidence/batch-07-repair.json` (SHA: `d99a37ee09a8ebe6d80c7cc3cea2d858d60753b5b28783b1ac2a6a02196837ec`). No migration SQL executed. History-only operation.
**Batch 8 repair summary:** 15 versions (227-241) now tracked in remote schema_migrations. Remote count 209 -> 224 (+15). 101-246 tracked count 113 -> 128 (+15). 120 total completed migration-history repairs. Verification evidence: `docs/migrations/evidence/batch-08-production-verification.json` (V3 SHA: `f2d54c694f97858fb523247834587bcc3257f8715446ce5d2034086870913c95`). Repair evidence: `docs/migrations/evidence/batch-08-repair.json` (SHA: `fc5b5a9f8dce28507764c4bd7bf9a39adc29a1302784da47b3e67c017d84a9e7`). No migration SQL executed. History-only operation.
**Batch 9 repair summary:** 4 versions (242, 243, 245, 246) now tracked in remote schema_migrations. Remote count 224 -> 228 (+4). 101-246 tracked count 128 -> 132 (+4). 124 total completed migration-history repairs. Verification evidence: `docs/migrations/evidence/batch-09-production-verification.json` (V3 SHA: `ca531e1e6f23307d14948b89d854a985d6a56495539c072eb2ce3d17334a35c5`). Repair evidence: `docs/migrations/evidence/batch-09-repair.json` (SHA: `1bf9ad999576a73f2aa4e1f554f4a1806f5ec1e54270ffd9be4125fc048f1731`). No migration SQL executed. History-only operation.
...
- **132 aligned/tracked:** Batches 1-9 repaired (124 versions) + 8 individually tracked (115, 119, 176, 181, 182, 199, 200, 244)
- **0 verified and pending repair:** all actionable repairs complete
- **0 remaining candidates pending verification:** all actionable candidates verified
