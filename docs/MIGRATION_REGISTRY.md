...
| 246 | `phone_otp_challenges` | Production verified (Batch 9, waiting for Batch 8 repair closeout) | #35 | Batch 9 production-verified 2026-07-30. 13 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 245 | `fix_book_slot_atomic_overloads` | Production verified (Batch 9, waiting for Batch 8 repair closeout) | — | Batch 9 production-verified 2026-07-30. 4 objects: 3 exact match, 1 equivalent-stricter (`book_slot_atomic` execute grants — Migration 296 revokes EXECUTE from anon/authenticated with role-existence guards, stricter than original). Not yet remotely tracked. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 243 | `growth_credit_hardening` | Production verified (Batch 9, waiting for Batch 8 repair closeout) | — | Batch 9 production-verified 2026-07-30. 17 objects, all exact match. Supersedes 7 objects from Migration 242 (reserve_credits_atomic, consume_credits_atomic, release_expired_credits function bodies and grants, uq_growth_campaign_dedup constraint). Not yet remotely tracked. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 242 | `growth_credit_atomic` | Production verified (Batch 9, waiting for Batch 8 repair closeout) | — | Batch 9 production-verified 2026-07-30. 8 objects: 1 exact match, 7 superseded by Migration 243 (`243_growth_credit_hardening.sql`). Not yet remotely tracked. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 241 | `growth_engine` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 59 objects: 58 exact match, 1 superseded (`customer_consents.customer_consents_service_insert` policy — superseded by Migration 242). Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 240 | `ai_classification_log_owner_rls` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 1 object, exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 239 | `ai_conversation_config` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 13 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 238 | `remove_gupshup` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 2 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 237 | `opt_out_suppression` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 5 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 236 | `session_versioning` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 4 objects, all exact match. One comment-only raw-definition difference (normalized executable SQL identical; no committed matching blob exists). Not yet remotely tracked. V3 evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 235 | `catalog_order_quantity_validation` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 1 object, exact match. Supersedes Migration 231 `create_catalog_order_atomic` function body. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 234 | `revoke_catalog_order_public` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 2 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 233 | `atomic_recurring_charge` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 3 objects: 1 exact match, 1 equivalent-stricter (`process_recurring_charge.revoke_public` — Migration 295 closes DEFAULT PRIVILEGES gap), 1 superseded (function body superseded by Migration 244 `payment_source_classification`). Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 232 | `webhook_event_state_machine` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 3 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 231 | `atomic_catalog_order` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 1 object, superseded (function body superseded by Migration 235 `catalog_order_quantity_validation`). Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 230 | `attendance_rls_hardening` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 7 objects, all exact match. Supersedes Migration 229 `attendance_log.service_insert` policy. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 229 | `attendance_log` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 7 objects: 6 exact match, 1 superseded (`attendance_log.service_insert` policy — superseded by Migration 230 `attendance_rls_hardening`). Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 228 | `add_pending_subscription_status` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 1 object, exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
| 227 | `customer_ltv_tier` | Production verified (Batch 8, approved for history-only repair) | — | Batch 8 production-verified 2026-07-30. 2 objects, all exact match. Not yet remotely tracked. Verification evidence: `batch-08-production-verification.json` (V3 SHA `f2d54c69`). |
...
- **113 aligned/tracked:** Batches 1-7 repaired (105 versions) + 8 individually tracked (115, 119, 176, 181, 182, 199, 200, 244)
- **19 verified and pending repair:** Batch 8 (15 versions, active and approved for repair, V3 SHA `f2d54c69`) + Batch 9 (4 versions, verified but deferred, V3 SHA `ca531e1e`)
