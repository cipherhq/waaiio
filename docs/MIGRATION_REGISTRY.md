...
| 246 | `phone_otp_challenges` | Production verified (Batch 9, approved for history-only repair) | #35 | Batch 9 production-verified 2026-07-30. 13 objects, all exact match. Approved for history-only repair. Not yet remotely tracked. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 245 | `fix_book_slot_atomic_overloads` | Production verified (Batch 9, approved for history-only repair) | — | Batch 9 production-verified 2026-07-30. 4 objects: 3 exact match, 1 equivalent-stricter (`book_slot_atomic` execute grants — Migration 296 revokes EXECUTE from anon/authenticated with role-existence guards, stricter than original). Approved for history-only repair. Not yet remotely tracked. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 243 | `growth_credit_hardening` | Production verified (Batch 9, approved for history-only repair) | — | Batch 9 production-verified 2026-07-30. 17 objects, all exact match. Supersedes 7 objects from Migration 242 (reserve_credits_atomic, consume_credits_atomic, release_expired_credits function bodies and grants, uq_growth_campaign_dedup constraint). Approved for history-only repair. Not yet remotely tracked. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
| 242 | `growth_credit_atomic` | Production verified (Batch 9, approved for history-only repair) | — | Batch 9 production-verified 2026-07-30. 8 objects: 1 exact match, 7 superseded by Migration 243 (`243_growth_credit_hardening.sql`). Approved for history-only repair. Not yet remotely tracked. Verification evidence: `batch-09-production-verification.json` (V3 SHA `ca531e1e`). |
...
- **128 aligned/tracked:** Batches 1-8 repaired (120 versions) + 8 individually tracked (115, 119, 176, 181, 182, 199, 200, 244)
- **4 verified and pending repair:** Batch 9 (4 versions, active and approved for repair, V3 SHA `ca531e1e`)
