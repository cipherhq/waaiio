...
export const BUSINESS_CATEGORIES: Array<{
  ...
  { key: 'consultant', label: 'Professional Services', icon: '💼', flow: 'scheduling' },
  { key: 'church', label: 'Church', icon: '⛪', flow: 'scheduling' },
  { key: 'mosque', label: 'Mosque', icon: '🕌', flow: 'scheduling' },
  ...
  { key: 'tattoo', label: 'Tattoo Studio', icon: '🎨', flow: 'scheduling' },
  ...
  { key: 'shortlet', label: 'Short-term Rental', icon: '🏘️', flow: 'reservation' },
...
export const CATEGORY_LABELS: Record<BusinessCategoryKey, {
  ...
  church: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '⛪', receiptTitle: 'Appointment Confirmed', quantityLabel: 'guests', personLabel: 'Member', personLabelPlural: 'Members', hiddenStatuses: ['no_show'], serviceName: 'Appointment', serviceNamePlural: 'Appointments', namePlaceholder: 'e.g. Counseling Session, Meeting with Pastor, Prayer Request', defaultHasPrice: true },
  mosque: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🕌', receiptTitle: 'Appointment Confirmed', quantityLabel: 'guests', personLabel: 'Member', personLabelPlural: 'Members', hiddenStatuses: ['no_show'], serviceName: 'Appointment', serviceNamePlural: 'Appointments', namePlaceholder: 'e.g. Counseling, Nikah Consultation, Quran Class', defaultHasPrice: true },
