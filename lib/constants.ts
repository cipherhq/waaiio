...
export const CATEGORY_LABELS: Record<BusinessCategoryKey, {
  ...
  church: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '⛪', receiptTitle: 'Appointment Confirmed', quantityLabel: 'guests', personLabel: 'Member', personLabelPlural: 'Members', hiddenStatuses: ['no_show'], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Counseling Session, Meeting with Pastor', defaultHasPrice: true },
  mosque: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🕌', receiptTitle: 'Appointment Confirmed', quantityLabel: 'guests', personLabel: 'Member', personLabelPlural: 'Members', hiddenStatuses: ['no_show'], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Counseling, Nikah Consultation, Class', defaultHasPrice: true },
