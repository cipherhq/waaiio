...
export const CATEGORY_LABELS: Record<BusinessCategoryKey, {
  ...
  restaurant: { entityName: 'reservation', entityNamePlural: 'reservations', actionVerb: 'Book', confirmationEmoji: '🍽️', receiptTitle: 'Booking Confirmed', quantityLabel: 'guests', personLabel: 'Guest', personLabelPlural: 'Guests', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Table Reservation, Private Dining' },
  barber: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '💈', receiptTitle: 'Appointment Confirmed', quantityLabel: 'people', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Haircut, Beard Trim' },
  spa: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🧖', receiptTitle: 'Appointment Confirmed', quantityLabel: 'people', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Full Body Massage, Facial' },
  salon: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '💇', receiptTitle: 'Appointment Confirmed', quantityLabel: 'people', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Haircut & Styling, Braiding' },
  gym: { entityName: 'session', entityNamePlural: 'sessions', actionVerb: 'Book', confirmationEmoji: '🏋️', receiptTitle: 'Session Confirmed', quantityLabel: 'people', personLabel: 'Member', personLabelPlural: 'Members', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Personal Training, Group Class' },
  ...
  shop: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '🛍️', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Product', serviceNamePlural: 'Products', namePlaceholder: 'e.g. T-Shirt, Gift Box' },
  food_delivery: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '🛵', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Menu Item', serviceNamePlural: 'Menu Items', namePlaceholder: 'e.g. Jollof Rice, Shawarma' },
  events: { entityName: 'ticket', entityNamePlural: 'tickets', actionVerb: 'Buy', confirmationEmoji: '🎪', receiptTitle: 'Tickets Confirmed', quantityLabel: 'tickets', personLabel: 'Attendee', personLabelPlural: 'Attendees', hiddenStatuses: ['no_show', 'in_progress'], serviceName: 'Event', serviceNamePlural: 'Events', namePlaceholder: 'e.g. Concert, Workshop' },
  transport: { entityName: 'ticket', entityNamePlural: 'tickets', actionVerb: 'Buy', confirmationEmoji: '🚌', receiptTitle: 'Ticket Confirmed', quantityLabel: 'seats', personLabel: 'Attendee', personLabelPlural: 'Attendees', hiddenStatuses: ['no_show', 'in_progress'], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Lagos–Abuja, Express Route' },
  cinema: { entityName: 'ticket', entityNamePlural: 'tickets', actionVerb: 'Buy', confirmationEmoji: '🎬', receiptTitle: 'Ticket Confirmed', quantityLabel: 'seats', personLabel: 'Attendee', personLabelPlural: 'Attendees', hiddenStatuses: ['no_show', 'in_progress'], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Regular, VIP, IMAX' },
  // ── New Categories ──
  ...
  tattoo: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🎨', receiptTitle: 'Appointment Confirmed', quantityLabel: 'sessions', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Small Tattoo, Cover-up' },
  real_estate: { entityName: 'viewing', entityNamePlural: 'viewings', actionVerb: 'Book', confirmationEmoji: '🏠', receiptTitle: 'Viewing Confirmed', quantityLabel: 'viewings', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Property Viewing, Consultation' },
  travel_agency: { entityName: 'booking', entityNamePlural: 'bookings', actionVerb: 'Book', confirmationEmoji: '✈️', receiptTitle: 'Booking Confirmed', quantityLabel: 'travelers', personLabel: 'Traveler', personLabelPlural: 'Travelers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Travel Consultation, Visa Assist' },
  ...
  instagram_vendor: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '🛒', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Product', serviceNamePlural: 'Products', namePlaceholder: 'e.g. Custom Order, Bundle Deal' },
  crowdfunding_org: { entityName: 'donation', entityNamePlural: 'donations', actionVerb: 'Donate', confirmationEmoji: '❤️', receiptTitle: 'Donation Received', quantityLabel: 'amount', personLabel: 'Donor', personLabelPlural: 'Donors', hiddenStatuses: ['no_show', 'in_progress', 'confirmed'], serviceName: 'Campaign', serviceNamePlural: 'Campaigns', namePlaceholder: 'e.g. Medical Fund, Community Project' },
  laundry: { entityName: 'pickup', entityNamePlural: 'pickups', actionVerb: 'Book', confirmationEmoji: '👔', receiptTitle: 'Pickup Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Wash & Fold, Dry Cleaning' },
  veterinary: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🐾', receiptTitle: 'Appointment Confirmed', quantityLabel: 'pets', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Consultation, Vaccination' },
  dental: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🦷', receiptTitle: 'Appointment Confirmed', quantityLabel: 'patients', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Check-up, Cleaning, Filling' },
  coworking: { entityName: 'booking', entityNamePlural: 'bookings', actionVerb: 'Book', confirmationEmoji: '🏢', receiptTitle: 'Space Booked', quantityLabel: 'desks', personLabel: 'Member', personLabelPlural: 'Members', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Hot Desk, Private Office' },
  tutor: { entityName: 'session', entityNamePlural: 'sessions', actionVerb: 'Book', confirmationEmoji: '📚', receiptTitle: 'Session Confirmed', quantityLabel: 'students', personLabel: 'Student', personLabelPlural: 'Students', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Private Lesson, Group Session' },
  photographer: { entityName: 'session', entityNamePlural: 'sessions', actionVerb: 'Book', confirmationEmoji: '📷', receiptTitle: 'Session Confirmed', quantityLabel: 'sessions', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Portrait Session, Event Coverage' },
  mall_vendor: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '🏪', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Product', serviceNamePlural: 'Products', namePlaceholder: 'e.g. Perfume, Accessories' },
  pharmacy: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '💊', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Product', serviceNamePlural: 'Products', namePlaceholder: 'e.g. Prescription, OTC Medicine' },
  hotel: { entityName: 'reservation', entityNamePlural: 'reservations', actionVerb: 'Book', confirmationEmoji: '🛏️', receiptTitle: 'Reservation Confirmed', quantityLabel: 'nights', personLabel: 'Guest', personLabelPlural: 'Guests', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Standard Room, Deluxe Suite' },
  car_wash: { entityName: 'booking', entityNamePlural: 'bookings', actionVerb: 'Book', confirmationEmoji: '🚿', receiptTitle: 'Booking Confirmed', quantityLabel: 'vehicles', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Basic Wash, Full Detail' },
  catering: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '🍳', receiptTitle: 'Order Confirmed', quantityLabel: 'servings', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Party Package, Corporate Lunch' },
  ...
  tailor: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '✂️', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. Custom Suit, Alteration' },
  other: { entityName: 'booking', entityNamePlural: 'bookings', actionVerb: 'Book', confirmationEmoji: '✅', receiptTitle: 'Booking Confirmed', quantityLabel: 'slots', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services', namePlaceholder: 'e.g. General Booking' },
};
