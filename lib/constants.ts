...
export const CATEGORY_LABELS: Record<BusinessCategoryKey, {
  ...
  restaurant: { entityName: 'reservation', entityNamePlural: 'reservations', actionVerb: 'Book', confirmationEmoji: '🍽️', receiptTitle: 'Booking Confirmed', quantityLabel: 'guests', personLabel: 'Guest', personLabelPlural: 'Guests', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  barber: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '💈', receiptTitle: 'Appointment Confirmed', quantityLabel: 'people', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  spa: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🧖', receiptTitle: 'Appointment Confirmed', quantityLabel: 'people', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  salon: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '💇', receiptTitle: 'Appointment Confirmed', quantityLabel: 'people', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  gym: { entityName: 'session', entityNamePlural: 'sessions', actionVerb: 'Book', confirmationEmoji: '🏋️', receiptTitle: 'Session Confirmed', quantityLabel: 'people', personLabel: 'Member', personLabelPlural: 'Members', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  clinic: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🏥', receiptTitle: 'Appointment Confirmed', quantityLabel: 'patients', personLabel: 'Patient', personLabelPlural: 'Patients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  consultant: { entityName: 'consultation', entityNamePlural: 'consultations', actionVerb: 'Book', confirmationEmoji: '💼', receiptTitle: 'Consultation Confirmed', quantityLabel: 'attendees', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  church: { entityName: 'payment', entityNamePlural: 'payments', actionVerb: 'Pay', confirmationEmoji: '⛪', receiptTitle: 'Payment Received', quantityLabel: 'amount', personLabel: 'Member', personLabelPlural: 'Members', hiddenStatuses: ['no_show', 'in_progress', 'confirmed'], serviceName: 'Giving Category', serviceNamePlural: 'Giving Categories' },
  mosque: { entityName: 'payment', entityNamePlural: 'payments', actionVerb: 'Pay', confirmationEmoji: '🕌', receiptTitle: 'Payment Received', quantityLabel: 'amount', personLabel: 'Member', personLabelPlural: 'Members', hiddenStatuses: ['no_show', 'in_progress', 'confirmed'], serviceName: 'Offering', serviceNamePlural: 'Offerings' },
  school: { entityName: 'payment', entityNamePlural: 'payments', actionVerb: 'Pay', confirmationEmoji: '🎓', receiptTitle: 'Payment Received', quantityLabel: 'amount', personLabel: 'Student', personLabelPlural: 'Students', hiddenStatuses: ['no_show', 'in_progress', 'confirmed'], serviceName: 'Fee Category', serviceNamePlural: 'Fee Categories' },
  ngo: { entityName: 'donation', entityNamePlural: 'donations', actionVerb: 'Donate', confirmationEmoji: '🤝', receiptTitle: 'Donation Received', quantityLabel: 'amount', personLabel: 'Donor', personLabelPlural: 'Donors', hiddenStatuses: ['no_show', 'in_progress', 'confirmed'], serviceName: 'Program', serviceNamePlural: 'Programs' },
  shop: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '🛍️', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Product', serviceNamePlural: 'Products' },
  food_delivery: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '🛵', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Menu Item', serviceNamePlural: 'Menu Items' },
  events: { entityName: 'ticket', entityNamePlural: 'tickets', actionVerb: 'Buy', confirmationEmoji: '🎪', receiptTitle: 'Tickets Confirmed', quantityLabel: 'tickets', personLabel: 'Attendee', personLabelPlural: 'Attendees', hiddenStatuses: ['no_show', 'in_progress'], serviceName: 'Event', serviceNamePlural: 'Events' },
  transport: { entityName: 'ticket', entityNamePlural: 'tickets', actionVerb: 'Buy', confirmationEmoji: '🚌', receiptTitle: 'Ticket Confirmed', quantityLabel: 'seats', personLabel: 'Attendee', personLabelPlural: 'Attendees', hiddenStatuses: ['no_show', 'in_progress'], serviceName: 'Service', serviceNamePlural: 'Services' },
  cinema: { entityName: 'ticket', entityNamePlural: 'tickets', actionVerb: 'Buy', confirmationEmoji: '🎬', receiptTitle: 'Ticket Confirmed', quantityLabel: 'seats', personLabel: 'Attendee', personLabelPlural: 'Attendees', hiddenStatuses: ['no_show', 'in_progress'], serviceName: 'Service', serviceNamePlural: 'Services' },
  // ── New Categories ──
  car_park: { entityName: 'parking', entityNamePlural: 'parking passes', actionVerb: 'Pay', confirmationEmoji: '🅿️', receiptTitle: 'Parking Paid', quantityLabel: 'vehicles', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: ['no_show', 'in_progress', 'confirmed'], serviceName: 'Service', serviceNamePlural: 'Services' },
  tattoo: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🎨', receiptTitle: 'Appointment Confirmed', quantityLabel: 'sessions', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  real_estate: { entityName: 'viewing', entityNamePlural: 'viewings', actionVerb: 'Book', confirmationEmoji: '🏠', receiptTitle: 'Viewing Confirmed', quantityLabel: 'viewings', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  travel_agency: { entityName: 'booking', entityNamePlural: 'bookings', actionVerb: 'Book', confirmationEmoji: '✈️', receiptTitle: 'Booking Confirmed', quantityLabel: 'travelers', personLabel: 'Traveler', personLabelPlural: 'Travelers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  logistics: { entityName: 'shipment', entityNamePlural: 'shipments', actionVerb: 'Order', confirmationEmoji: '🚚', receiptTitle: 'Shipment Confirmed', quantityLabel: 'packages', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  taxi: { entityName: 'ride', entityNamePlural: 'rides', actionVerb: 'Pay', confirmationEmoji: '🚕', receiptTitle: 'Ride Payment', quantityLabel: 'rides', personLabel: 'Rider', personLabelPlural: 'Riders', hiddenStatuses: ['no_show', 'in_progress', 'confirmed'], serviceName: 'Service', serviceNamePlural: 'Services' },
  government: { entityName: 'payment', entityNamePlural: 'payments', actionVerb: 'Pay', confirmationEmoji: '🏛️', receiptTitle: 'Payment Received', quantityLabel: 'amount', personLabel: 'Citizen', personLabelPlural: 'Citizens', hiddenStatuses: ['no_show', 'in_progress', 'confirmed'], serviceName: 'Service', serviceNamePlural: 'Services' },
  instagram_vendor: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '🛒', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Product', serviceNamePlural: 'Products' },
  crowdfunding_org: { entityName: 'donation', entityNamePlural: 'donations', actionVerb: 'Donate', confirmationEmoji: '❤️', receiptTitle: 'Donation Received', quantityLabel: 'amount', personLabel: 'Donor', personLabelPlural: 'Donors', hiddenStatuses: ['no_show', 'in_progress', 'confirmed'], serviceName: 'Campaign', serviceNamePlural: 'Campaigns' },
  laundry: { entityName: 'pickup', entityNamePlural: 'pickups', actionVerb: 'Book', confirmationEmoji: '👔', receiptTitle: 'Pickup Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  veterinary: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🐾', receiptTitle: 'Appointment Confirmed', quantityLabel: 'pets', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  dental: { entityName: 'appointment', entityNamePlural: 'appointments', actionVerb: 'Book', confirmationEmoji: '🦷', receiptTitle: 'Appointment Confirmed', quantityLabel: 'patients', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  coworking: { entityName: 'booking', entityNamePlural: 'bookings', actionVerb: 'Book', confirmationEmoji: '🏢', receiptTitle: 'Space Booked', quantityLabel: 'desks', personLabel: 'Member', personLabelPlural: 'Members', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  tutor: { entityName: 'session', entityNamePlural: 'sessions', actionVerb: 'Book', confirmationEmoji: '📚', receiptTitle: 'Session Confirmed', quantityLabel: 'students', personLabel: 'Student', personLabelPlural: 'Students', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  photographer: { entityName: 'session', entityNamePlural: 'sessions', actionVerb: 'Book', confirmationEmoji: '📷', receiptTitle: 'Session Confirmed', quantityLabel: 'sessions', personLabel: 'Client', personLabelPlural: 'Clients', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  mall_vendor: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '🏪', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Product', serviceNamePlural: 'Products' },
  pharmacy: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '💊', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Product', serviceNamePlural: 'Products' },
  hotel: { entityName: 'reservation', entityNamePlural: 'reservations', actionVerb: 'Book', confirmationEmoji: '🛏️', receiptTitle: 'Reservation Confirmed', quantityLabel: 'nights', personLabel: 'Guest', personLabelPlural: 'Guests', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  car_wash: { entityName: 'booking', entityNamePlural: 'bookings', actionVerb: 'Book', confirmationEmoji: '🚿', receiptTitle: 'Booking Confirmed', quantityLabel: 'vehicles', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  catering: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '🍳', receiptTitle: 'Order Confirmed', quantityLabel: 'servings', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  funeral: { entityName: 'service', entityNamePlural: 'services', actionVerb: 'Pay', confirmationEmoji: '🌺', receiptTitle: 'Payment Received', quantityLabel: 'amount', personLabel: 'Family', personLabelPlural: 'Families', hiddenStatuses: ['no_show', 'in_progress', 'confirmed'], serviceName: 'Service', serviceNamePlural: 'Services' },
  tailor: { entityName: 'order', entityNamePlural: 'orders', actionVerb: 'Order', confirmationEmoji: '✂️', receiptTitle: 'Order Confirmed', quantityLabel: 'items', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
  other: { entityName: 'booking', entityNamePlural: 'bookings', actionVerb: 'Book', confirmationEmoji: '✅', receiptTitle: 'Booking Confirmed', quantityLabel: 'slots', personLabel: 'Customer', personLabelPlural: 'Customers', hiddenStatuses: [], serviceName: 'Service', serviceNamePlural: 'Services' },
};
