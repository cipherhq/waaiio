...
export const CATEGORY_DEFAULT_CAPABILITIES: Record<string, CapabilityId[]> = {
  ...
  nail_tech: ['scheduling', 'payment', 'feedback', 'loyalty', 'chat', 'referral', 'staff'],
  mua: ['scheduling', 'payment', 'feedback', 'chat', 'referral', 'invoice'],
  pet_grooming: ['scheduling', 'payment', 'feedback', 'loyalty', 'chat', 'referral'],
  therapy: ['scheduling', 'payment', 'chat', 'reminders'],
  bakery: ['ordering', 'payment', 'feedback', 'chat', 'referral'],
  mechanic: ['scheduling', 'payment', 'invoice', 'chat'],
  cleaning: ['scheduling', 'payment', 'invoice', 'chat', 'referral'],
  plumber: ['scheduling', 'payment', 'invoice', 'chat'],
  pest_control: ['scheduling', 'payment', 'invoice', 'chat'],
  driving_school: ['scheduling', 'payment', 'feedback', 'chat'],
  music_studio: ['scheduling', 'payment', 'feedback', 'loyalty', 'chat', 'staff'],
  legal: ['scheduling', 'payment', 'invoice', 'chat'],
  ...
  security: ['scheduling', 'payment', 'invoice', 'chat'],
  accounting: ['scheduling', 'payment', 'invoice', 'chat'],
