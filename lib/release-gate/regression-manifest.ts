...
export const REGRESSION_MANIFEST: DomainEntry[] = [
  {
    ...
    testSuites: [
      ...
      'lib/payments/__tests__/entity-balance.test.ts',
    ],
  ...
  },
  {
    ...
    testSuites: [
      ...
      'lib/__tests__/reg-saved-card-reuse-chain.test.ts',
      'lib/__tests__/reg-pin-lockout.test.ts',
      'lib/__tests__/reg-saved-card-invoice-giving-parity.test.ts',
    ],
