...
const selectAppointmentStep: FlowStepConfig = {
  ...
  async prompt(ctx: FlowContext): Promise<PromptMessage[]> {
    ...
    if (appointments.length === 1) {
      ...
      ctx.session.session_data._service_buffer_minutes = a.buffer_minutes || 0;
    ...
    if (appointment) {
      return {
        ...
        data: {
          ...
          _service_buffer_minutes: appointment.buffer_minutes || 0,
      ...
      if (match) {
        return {
          ...
          data: {
            ...
            _service_buffer_minutes: match.buffer_minutes || 0,
