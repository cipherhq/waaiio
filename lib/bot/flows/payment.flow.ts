  ...
  steps: [
    ...
    // ── Process Payment ──
    {
      ...
      async prompt(ctx: FlowContext): Promise<PromptMessage[]> {
        ...
        // Requires: NG/GH country, growth/business tier, active default bank account, amount >= minimum
        ...
        // No payment option available — show error
