...
function applySecurityHeaders(response: NextResponse): NextResponse {
  ...
  response.headers.set(
    ...
    [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.paystack.co https://api.stripe.com https://connect.squareup.com https://api.flutterwave.com https://graph.facebook.com https://www.facebook.com",
