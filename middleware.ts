...
function applySecurityHeaders(response: NextResponse): NextResponse {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' https://js.stripe.com https://js.squareup.com https://js.paystack.co https://*.facebook.net https://*.facebook.com https://us-assets.i.posthog.com https://maps.googleapis.com https://www.paypal.com https://www.sandbox.paypal.com",
      ...
      "frame-src 'self' https://js.stripe.com https://js.squareup.com https://checkout.paystack.com https://checkout.flutterwave.com https://*.facebook.com https://*.facebook.net https://www.paypal.com https://www.sandbox.paypal.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
