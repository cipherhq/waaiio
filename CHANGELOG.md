...
- **Tests added:** `lib/__tests__/p1-esig-1-multi-signer-pdf.test.ts` — 38 tests: PDF generation (12), data assembly (4), signer persistence errors (4), allSigned behavioral (7), finalization source verification (11).
