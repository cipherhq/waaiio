...
- **Procedure deviation:** dry run showed 79 migrations; approved procedure required stopping; Migration 298 SQL was executed through Supabase Management API SQL and recorded via `migration repair --status applied 298`. Production result verified correct. Original execution evidence contained inaccurate safety confirmations; corrected forensic evidence is canonical.
