        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          ...
          <div className="mx-auto mt-8 max-w-xl">
            <div className="relative">
              <svg aria-hidden="true" className="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-whatsapp px-6 py-3 text-sm font-bold text-white shadow-lg transition hover:bg-whatsapp/85"
            >
