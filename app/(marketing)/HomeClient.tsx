...
import { getSupportWhatsAppLink } from '@/lib/support-contact';
          ...
          <div className="grid w-full items-center gap-12 lg:grid-cols-2">
            ...
            <div className="text-center lg:text-left">
              ...
              >
                ...
                <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
                  <a
                    href={getSupportWhatsAppLink(undefined, 'I want to get started') || '/get-started'}
                    target={getSupportWhatsAppLink() ? '_blank' : undefined}
                    rel={getSupportWhatsAppLink() ? 'noopener noreferrer' : undefined}
              ...
              >
                <Image src="/meta-business-partner.svg" alt="Meta Business Partner" width={160} height={32} className="h-8 w-auto brightness-0 invert opacity-80" />
              </motion.div>
            </div>
      ...
      <section className="border-b border-gray-100 bg-gray-50 py-5">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <div className="flex items-center justify-center gap-8">
            <Image src="/meta-business-partner.svg" alt="Meta Business Partner" width={200} height={40} className="h-10 w-auto" />
