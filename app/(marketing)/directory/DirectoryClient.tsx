...
const SHARED_WHATSAPP_NUMBERS: Record<string, string> = {
              ...
              <div key={countryCode}>
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {bizList.map((biz) => {
                    ...
                    const sharedNumber = SHARED_WHATSAPP_NUMBERS[biz.country_code] || SHARED_WHATSAPP_NUMBERS.US || '';
                    ...
                    const hasWhatsAppNumber = !!(isShared ? sharedNumber : (dedicatedNumber || sharedNumber));
                      ...
                      >
                        ...
                        <div className="mt-4 rounded-xl bg-gray-50 p-3">
                          ...
                          <a
                            ...
                            className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-whatsapp py-2.5 text-sm font-bold text-white transition hover:bg-whatsapp/85"
                          >
                          ...
                          {biz.slug && (biz.capabilities.includes('scheduling') || biz.capabilities.includes('appointment')) && (
                            <Link
                              href={`/b/${biz.slug}`}
