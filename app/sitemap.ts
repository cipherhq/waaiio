...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/features`, changeFrequency: 'weekly', priority: 0.9, lastModified: NOW },
    { url: `${BASE_URL}/pricing`, changeFrequency: 'weekly', priority: 0.9, lastModified: NOW },
    { url: `${BASE_URL}/directory`, changeFrequency: 'daily', priority: 0.8, lastModified: NOW },
    ...
    { url: `${BASE_URL}/help`, changeFrequency: 'monthly', priority: 0.5, lastModified: NOW },
    ...
    { url: `${BASE_URL}/cookies`, changeFrequency: 'yearly', priority: 0.2, lastModified: NOW },
    { url: `${BASE_URL}/acceptable-use`, changeFrequency: 'yearly', priority: 0.2, lastModified: NOW },
    { url: `${BASE_URL}/dpa`, changeFrequency: 'yearly', priority: 0.2, lastModified: NOW },
  ];
}
