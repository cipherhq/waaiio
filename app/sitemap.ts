...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/blog/how-to-automate-salon-bookings-whatsapp`, changeFrequency: 'monthly', priority: 0.6, lastModified: new Date() },
    { url: `${BASE_URL}/blog/whatsapp-church-tithes-offerings-automation`, changeFrequency: 'monthly', priority: 0.6, lastModified: new Date() },
    { url: `${BASE_URL}/blog/restaurant-whatsapp-ordering-system`, changeFrequency: 'monthly', priority: 0.6, lastModified: new Date() },
