...
const HELP_ARTICLES: HelpArticle[] = [
  ...
  { category: 'Payments', question: 'What are the fees?', answer: 'Starter: 2.5% per transaction. Pro: 1.5% + monthly subscription. Premium: 1.0% + monthly subscription. All plans include a 7-day free trial with zero fees. Check the Pricing page for details.', link: '/pricing' },
