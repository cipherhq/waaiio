...
const CUSTOMER_OUTCOMES = [
  {
    ...
    desc: 'Customers pay you directly on WhatsApp — no cash, no transfers',
    examples: 'Parking, school fees, bills, churches, markets, vendors',
    groups: ['Faith & Community', 'Education & Training', 'Government & Public'],
  },
  {
    id: 'order_products',
    icon: '\uD83D\uDED2',
    title: 'Sell products or take orders',
    desc: 'Customers browse, order, and pay — all on WhatsApp',
    examples: 'Restaurants, shops, pharmacies, market vendors, bakeries',
  ...
  },
  {
    ...
    examples: 'Salons, clinics, gyms, photographers, lawyers',
    groups: [
  ...
  },
  {
    ...
    icon: '\uD83C\uDFAB',
    title: 'Sell tickets',
    desc: 'Events, transport, shows — with QR code check-in',
    examples: 'Concerts, bus tickets, conferences, church events',
    groups: ['Events & Entertainment', 'Transport', 'Transport & Logistics'],
  },
  {
    id: 'reserve_spot',
    icon: '\uD83C\uDFE8',
    title: 'Take reservations',
    desc: 'Customers book tables, rooms, or rentals',
    examples: 'Hotels, restaurants, car rentals, shortlets',
    groups: ['Hospitality'],
  },
  {
    id: 'request_service',
    ...
    desc: 'Customers tell you what they need, you handle the rest',
    examples: 'Laundry, cleaning, repairs, deliveries, movers',
    groups: ['Home & Auto Services'],
  },
];
...
const SEARCH_ALIASES: Record<string, string[]> = {
  ...
  'print': ['printing'],
  'funeral': ['funeral'],
  // Local economy / Nigerian context
  'pay': ['car_park', 'school', 'government', 'church', 'mosque', 'ngo'],
  'payment': ['car_park', 'school', 'government', 'church', 'mosque', 'ngo'],
  'fees': ['school', 'government', 'daycare'],
  'bill': ['government', 'school'],
  'bills': ['government', 'school'],
  'collect': ['car_park', 'school', 'government', 'church'],
  'vendor': ['shop', 'food_delivery', 'food_truck'],
  'market': ['shop', 'supermarket', 'food_delivery'],
  'sell': ['shop', 'food_delivery', 'supermarket', 'bakery', 'events'],
  'store': ['shop', 'supermarket', 'pharmacy'],
  'grocery': ['supermarket'],
  'mall': ['shop', 'supermarket'],
  'chemist': ['pharmacy'],
  'drug': ['pharmacy'],
  'provision': ['shop', 'supermarket'],
  'mama put': ['restaurant', 'food_truck'],
  'buka': ['restaurant'],
  'suya': ['food_truck', 'restaurant'],
  'chop': ['restaurant', 'food_truck'],
  'catering': ['catering'],
  'aso ebi': ['tailor', 'events'],
  'ankara': ['tailor'],
  'fabric': ['tailor'],
  'keke': ['taxi', 'transport'],
  'okada': ['courier', 'taxi'],
  ...
  'wig': ['salon'],
  'creche': ['daycare'],
  'nursery': ['daycare', 'school'],
  'lesson': ['tutor', 'school'],
  'tutorial': ['tutor'],
  'jamb': ['tutor', 'school'],
  'waec': ['tutor', 'school'],
  'towing': ['mechanic', 'taxi'],
  'plumbing': ['plumber'],
  'electric': ['electrician'],
  'ac': ['hvac'],
  'fumigation': ['pest_control'],
  'shawarma': ['food_truck', 'restaurant'],
  'smoothie': ['cafe', 'restaurant'],
  'juice': ['cafe', 'restaurant'],
  'club': ['bar', 'lounge', 'events'],
  'lounge': ['lounge', 'bar'],
  'beach': ['events', 'hotel'],
  'resort': ['hotel'],
  'guest': ['hotel', 'shortlet'],
  'studio': ['music_studio', 'yoga', 'pilates', 'photographer', 'tattoo'],
};
