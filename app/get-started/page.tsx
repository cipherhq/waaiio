      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="flex flex-1 items-start justify-center overflow-y-auto px-4 py-8 lg:px-10">
          <div className="w-full max-w-xl">
            ...
            {step === 'plan' && (
              <div>
                <button type="button" onClick={() => setStep('features')} className="mb-4 flex items-center gap-1 text-sm text-gray-500 hover:text-brand">
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
                  Back
                </button>
                  ...
                  <>
                    ...
                    <div className="mt-6 rounded-2xl bg-green-50 border border-green-200 p-5">
                      ...
                      <div className="mt-4 flex gap-2 justify-center">
                        ...
                        <a href={waLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-lg px-4 py-2 text-xs font-bold text-white" style={{ backgroundColor: '#25D366' }}>
