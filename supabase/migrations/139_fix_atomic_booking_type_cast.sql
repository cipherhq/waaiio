-- Fix type mismatch in book_slot_atomic: time column is TIME type, not text
-- Also fix date comparison (date column is DATE type)
...
BEGIN
  ...
  -- Cast p_time to TIME for comparison with the time column
